...
# my_file = ['from-net-1.wav', 'from-net-2.wav', 'from-net-3.wav']
my_file = ['1.wav', '2.wav']
...
for f_dir in my_dir:
    ...
    for f_file in my_file:
        [Fs, x] = audioBasicIO.readAudioFile("D:/ML/dataset_paper/person1/" + f_dir + "/" + f_file)
...
# pre_file = ['1.wav', '2.wav', '3.wav', '4.wav', '5.wav', '6.wav', '7.wav', '8.wav', '9.wav', '10.wav',
#             '11.wav', '12.wav', '13.wav', '14.wav', '15.wav', '16.wav', '17.wav', '18.wav', '19.wav',
#             'xsb-common.wav.wav', 'from-net-1.wav', 'from-net-2.wav', 'from-net-3.wav']
...
for p_dir in pre_dir:
    ...
    for p_file in pre_file:
        [Fs, x] = audioBasicIO.readAudioFile("D:/ML/dataset_paper/person2/" + p_dir + '/' + p_file)
        F = audioFeatureExtraction.stFeatureExtraction(x, Fs, 0.050 * Fs, 0.025 * Fs)
