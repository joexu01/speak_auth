(function (exports) {
    ...
    var MP3Recorder = function (config) {
        ...
        var recorder = this;
        config = config || {};
        config.sampleRate = config.sampleRate || 12050;//音频采样率
        config.bitRate = config.bitRate || 64;//音频码率

        navigator.getUserMedia = navigator.getUserMedia ||
                                 navigator.webkitGetUserMedia ||
                                 navigator.mozGetUserMedia ||
                                 navigator.msGetUserMedia;//调用浏览器设备
        ...
        if (navigator.getUserMedia) {
            ...
            function (stream) {
                ...
                var realTimeWorker = new Worker('/static/worker-realtime.js');
